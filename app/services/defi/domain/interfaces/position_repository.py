...
class IPositionRepository(ABC):
    ...
    @abstractmethod
    async def list_by_pool(self, pool_address: str, chain_id: int) -> list[Position]: ...
    ...
    @abstractmethod
    async def exists(self, position_id: uuid.UUID) -> bool: ...

    @abstractmethod
    async def count_by_owner(self, owner: str, chain_id: int) -> int: ...
