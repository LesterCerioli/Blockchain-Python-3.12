...
class RpcProvider(BaseProvider):
    """
    Concrete provider backed by a raw JSON-RPC endpoint (Geth, Erigon,
    Infura, Alchemy, QuickNode, etc.).  Circuit breaking is handled by
    the base class; this class only adds the transport.
    """
